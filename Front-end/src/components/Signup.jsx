          ...
          <AnimatePresence mode="wait">
            {isSuccess ? (
              ...
              >
                ...
                <p className="text-xs text-slate-400">Deploying new credentials and establishing secure gateway...</p>
              </motion.div>
            ) : (
              <motion.div 
                key="form"
              ...
              >
                ...
                <div className="border-b border-slate-800 pb-4">
                  <h3 className="text-lg font-extrabold text-white tracking-tight">Create Ecosystem Account</h3>
                  <p className="text-xs text-slate-400 mt-1">Register as a citizen responder or accredited rescue professional.</p>
                </div>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  ...
                  {(selectedRole === "Responder" || selectedRole === "NGO") && (
                    ...
                    >
                      <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Credentials / Licensing ID</label>
                      <div className="relative">
