...
export default function Signup({ initialRole = "Citizen", onAuthSuccess, onNavigateToLogin }) {
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="space-y-4 pt-4 text-left">
              ...
              <p className="text-slate-600 text-xs leading-relaxed font-light">
                Become part of our welfare net to save strays, track clinical services, or coordinate response dispatches.
              </p>
            </div>
          </div>
          ...
          <AnimatePresence mode="wait">
            {isSuccess ? (
              ...
              >
                ...
                <h3 className="text-xl font-extrabold text-[#2C2C2C]">Registration Handshake Successful</h3>
                <p className="text-xs text-slate-500 font-light">Creating secure profile ledger and launching portal...</p>
              </motion.div>
            ) : (
              <motion.div 
                key="form"
              ...
              >
                ...
                <div className="border-b border-[#EFE7DC] pb-4">
                  <h3 className="text-lg font-extrabold text-[#2C2C2C] tracking-tight">Create Account</h3>
                  <p className="text-xs text-slate-500 mt-1 font-light">Join PawLink to get involved today.</p>
                </div>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-3.5">
                  ...
                  {(selectedRole === "Responder" || selectedRole === "NGO") && (
                    ...
                    >
                      <label className="text-[10px] text-[#C68B59] font-extrabold uppercase tracking-widest block">
                        {selectedRole === "NGO" ? "NGO Identification Code" : "Paramedic/Rescue Licensing ID"}
                      </label>
                      <input 
                        type="text" 
                        placeholder={selectedRole === "NGO" ? "e.g. NGO-IND-894-A" : "e.g. EMT-901-REG"} 
                        value={license}
                        onChange={e => setLicense(e.target.value)}
                        className="w-full bg-[#FAF8F5] border border-[#D8C3A5] rounded-xl py-2.5 px-4 text-xs text-[#2C2C2C] placeholder-slate-400 focus:outline-none focus:border-[#C68B59] focus:ring-1 focus:ring-[#C68B59] transition-all font-mono"
                        required
                      />
                    </motion.div>
                  )}
